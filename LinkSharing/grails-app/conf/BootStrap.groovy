...
*/
    ...
    def createUsers(){
        ...
        User user1= new User(firstName: "fname1",lastName: "lName1",password: "123456",\
         userName: "uName1",active: true,admin: true,email: "abc1@gmail.com",userPhoto: "1415862099999.png").save(failOnError: true)

       User user2= new User(firstName: "fname2",lastName: "lName2",password: "123456",\
         userName: "uName2",active: true,admin: false,email: "abc2@gmail.com" ,userPhoto: "1415862127468.png").save(failOnError: true)
